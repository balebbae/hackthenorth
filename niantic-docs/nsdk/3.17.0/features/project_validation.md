---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/features/project_validation/
...
<img src="https://www.nianticspatial.com/docs/assets/images/project_validation_activate-3e4fdaff1eda11998bbf27d76c6de29f.png" width="800" alt="Warning that Lightship ARDK is not activated." />

Pressing the **Edit** button next to it opens the page where you can tick the checkbox to activate NSDK for that platform.

### Is your API Key set?<a href="#is-your-api-key-set" class="hash-link" aria-label="Direct link to Is your API Key set?" title="Direct link to Is your API Key set?">​</a>

If you are using certain features of the NSDK, you will need to set your API key:

<img src="https://www.nianticspatial.com/docs/assets/images/project_validation_api_key.png" width="800" alt="Error that Lightship ARDK has enabled features that use API Key." />
...
<img src="https://www.nianticspatial.com/docs/assets/images/project_validation_fix_all-e540114de5923f199b441c32e7254f17.png" width="800" alt="Error that Lightship ARDK has enabled features that use API Key." />
