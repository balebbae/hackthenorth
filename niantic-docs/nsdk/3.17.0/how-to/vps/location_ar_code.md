---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/how-to/vps/location_ar_code/
...
1.  You will need a Unity project with ARDK installed and a set-up basic AR scene. For more information, see [Setup ARDK 3](https://www.nianticspatial.com/docs/nsdk/3.17.0/setup/) and [Setting up a Basic AR Scene](https://www.nianticspatial.com/docs/nsdk/3.17.0/setup/#setting-up-a-basic-ar-scene).
2.  If you have not added one, you will need a valid [API Key](https://www.nianticspatial.com/docs/nsdk/3.17.0/setup/#create-a-lightship-account-and-add-api-key).
3.  Your project must have an `ARLocationManager` in its AR scene to use this How-To. See Step 4 of [Adding a Real-World Location to Unity](https://www.nianticspatial.com/docs/nsdk/3.17.0/how-to/vps/real_world_location_ar/#adding-a-real-world-location-to-unity) to learn how to add an `ARLocationManager` and an `ARLocation` to your project. (For [Swapping ARLocations](#swapping-locations-using-code), you will need more than one `ARLocation`.)
