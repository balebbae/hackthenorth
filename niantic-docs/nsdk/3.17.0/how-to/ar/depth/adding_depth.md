---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/how-to/ar/depth/adding_depth/
...
The [NSDK sample project](https://www.nianticspatial.com/docs/nsdk/3.17.0/sample_projects/) includes an example of running depth.

Also, see [How to Convert a Screen Point to Real-World Position Using Depth](https://www.nianticspatial.com/docs/nsdk/3.17.0/how-to/ar/depth/convert_point_world_position/) for a guide of how to set up a project with depth.
