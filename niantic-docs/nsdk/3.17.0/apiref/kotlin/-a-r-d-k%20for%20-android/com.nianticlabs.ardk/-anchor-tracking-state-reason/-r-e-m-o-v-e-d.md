---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/-anchor-tracking-state-reason/-r-e-m-o-v-e-d/
title: index
---
...
\[androidJvm\]\
[REMOVED](https://www.nianticspatial.com/docs/nsdk/3.17.0/)

The anchor has been explicitly removed from tracking.

This reason indicates that the anchor was removed via `removeAnchor` and is no longer being tracked by the system.
