---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/-w-p-s-error/-n-o_-h-e-a-d-i-n-g/
title: index
---
...
\[androidJvm\]\
[NO_HEADING](https://www.nianticspatial.com/docs/nsdk/3.17.0/)

No compass data has been provided to the system.

This error indicates that the device is not receiving compass/magnetometer data. This may occur due to magnetic interference or sensor issues.
