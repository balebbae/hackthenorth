---
source: https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/-ardk-feature-already-initialized-status-exception/
title: index
---
...
[ARDK for Android](https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/)/[com.nianticlabs.ardk](https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/)/[ArdkFeatureAlreadyInitializedStatusException](https://www.nianticspatial.com/docs/nsdk/3.17.0/)

<div>

# ArdkFeatureAlreadyInitializedStatusException

</div>

\[androidJvm\]\
class [ArdkFeatureAlreadyInitializedStatusException](https://www.nianticspatial.com/docs/nsdk/3.17.0/)(message: <a href="https://kotlinlang.org/api/latest/jvm/stdlib/kotlin-stdlib/kotlin/-string/index.html" target="_blank" rel="noopener noreferrer">String</a>? = null) : [ArdkStatusException](https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/-ardk-status-exception/)

Thrown when a feature is already initialized. Corresponds to [ARDKStatus.FEATURE_ALREADY_INITIALIZED](https://www.nianticspatial.com/docs/nsdk/3.17.0/apiref/kotlin/-a-r-d-k%20for%20-android/com.nianticlabs.ardk/-a-r-d-k-status/-f-e-a-t-u-r-e_-a-l-r-e-a-d-y_-i-n-i-t-i-a-l-i-z-e-d/).
...
<tbody>
<tr>
<td>ArdkFeatureAlreadyInitializedStatusException</td>
<td>[androidJvm]<br />
