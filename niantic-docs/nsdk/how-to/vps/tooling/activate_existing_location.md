---
source: https://www.nianticspatial.com/docs/nsdk/how-to/vps/tooling/activate_existing_location/
...
The Geospatial Browser is no longer available, so the activation steps on this page cannot be completed. They are retained as a reference for older VPS projects. For current projects, create and manage Sites in <a href="https://scaniverse.nianticspatial.com/" target="_blank" rel="noopener noreferrer">Scaniverse Web</a>.
...
If you have issues with the activation process, [contact us](https://www.nianticspatial.com/docs/nsdk/contact_us/).
