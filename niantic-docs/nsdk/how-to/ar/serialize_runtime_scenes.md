---
source: https://www.nianticspatial.com/docs/nsdk/how-to/ar/serialize_runtime_scenes/
...
You will need a Unity project with NSDK AR enabled. For more information, see [Set up the Niantic SDK for Unity](https://www.nianticspatial.com/docs/nsdk/setup/#set-up-the-niantic-sdk-for-unity).
...
For more information on using Location AR, see [Creating Location AR Experiences with VPS](https://www.nianticspatial.com/docs/nsdk/features/lightship_vps/).
