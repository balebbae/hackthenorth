---
source: https://www.nianticspatial.com/docs/nsdk/features/lightship_vps/
...
The Geospatial Browser is no longer available. References to it on this page are retained for developers maintaining older VPS projects. For current projects, manage Sites in <a href="https://scaniverse.nianticspatial.com/" target="_blank" rel="noopener noreferrer">Scaniverse Web</a> and use [VPS2](https://www.nianticspatial.com/docs/nsdk/features/vps2/).
...
The Niantic Scaniverse App allows you to capture and submit scans at Public Locations to improve the coverage of VPS. You can also use the app to create Private VPS Locations for your own rapid testing and development. Finally, the Scaniverse App can be used to test localization at Public Locations and Private VPS Locations.

A VPS developers portal on scaniverse.nianticspatial.com that lets you manage sites within your organization. Niantic Spatial VPS APIs make requests to the VPS backend, which needs to receive user information such as user location and an ID unique to the user using your app to make the requests. To facilitate this, NSDK provides a User ID data element that’s automatically used in VPS requests. This User ID is considered private user data, and your app will need to provide privacy policies and guidance for handling private user data, as described in NSDK and Data Privacy.
...
To learn how to do this, see the [Mesh Download How-To](https://www.nianticspatial.com/docs/nsdk/how-to/vps/mesh_download/).

## Next Steps<a href="#next-steps" class="hash-link" aria-label="Direct link to Next Steps" title="Direct link to Next Steps">​</a>

### VPS Locations Discovery & Management:<a href="#vps-locations-discovery--management" class="hash-link" aria-label="Direct link to VPS Locations Discovery &amp; Management:" title="Direct link to VPS Locations Discovery &amp; Management:">​</a>

1.  [How to Use the Geospatial Browser](https://www.nianticspatial.com/docs/nsdk/how-to/vps/tooling/use_geospatial_browser/)
2.  [How to Create a VPS-Activated Location](https://www.nianticspatial.com/docs/nsdk/how-to/vps/tooling/create_vps_activated_location/)
3.  [How to Manage Test Scans](https://www.nianticspatial.com/docs/nsdk/how-to/vps/tooling/manage_test_scans/)
...
4.  [Getting Started with VPS](https://www.nianticspatial.com/docs/nsdk/how-to/vps/location_manager/)
