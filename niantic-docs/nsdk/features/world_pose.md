---
source: https://www.nianticspatial.com/docs/nsdk/features/world_pose/
...
To see some of the WPS use cases in action, try out the [Sample Project](https://www.nianticspatial.com/docs/nsdk/sample_projects/).
