---
source: https://www.nianticspatial.com/docs/nsdk/features/device_mapping/
...
| Do you need to communicate with Niantic Spatial VPS Servers? | Yes | No |
| Where does the map data live? | Niantic Spatial servers | Your device |
