---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.Sites.SitesClientManager.GetSitesForOrganizationAsync/
title: GetSitesForOrganizationAsync
---
...
<td><span id="external parameter-orgid"></span><span class="ctoken-line"><span class="ctoken class-name">orgId</span></span></td>
<td><span class="ctoken-line"><span class="ctoken class-name keyword">string</span></span></td>
<td><div class="ctoken comment">
The organization ID to query sites for.
</div></td>
</tr>
<tr class="api-table-row">
