---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.SceneSegmentation.ARSceneSegmentationManager.GetChannelsAt/
title: GetChannelsAt
---
...
An array of channels present for the pixel.
