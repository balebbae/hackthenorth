---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.SceneSegmentation.ARSceneSegmentationManager.GetChannelFromName/
title: GetChannelFromName
---
...
The SceneSegmentationChannel enum value if found, otherwise null.
...
<td><span id="external parameter-channelname"></span><span class="ctoken-line"><span class="ctoken class-name">channelName</span></span></td>
<td><span class="ctoken-line"><span class="ctoken class-name keyword">string</span></span></td>
<td><div class="ctoken comment">
The channel name string (e.g., "sky", "ground", "natural_ground").
</div></td>
</tr>
</tbody>
</table>
