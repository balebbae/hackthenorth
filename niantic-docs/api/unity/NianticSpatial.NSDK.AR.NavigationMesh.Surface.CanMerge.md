---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.NavigationMesh.Surface.CanMerge/
title: CanMerge
---
...
<span class="ctoken-line"><span class="ctoken keyword">public</span><span class="ctoken plain"> </span><span class="ctoken class-name keyword">bool</span><span class="ctoken plain"> </span><span class="ctoken class-name">CanMerge</span><span class="ctoken punctuation">(</span><span class="ctoken class-name">[Surface](https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.NavigationMesh.Surface/ "Represents a subset on the grid with cells of approximately the same elevation.")</span><span class="ctoken plain"> </span><span class="ctoken class-name">other</span><span class="ctoken punctuation">,</span><span class="ctoken plain"> </span><span class="ctoken class-name keyword">float</span><span class="ctoken plain"> </span><span class="ctoken class-name">elevationTreshold</span><span class="ctoken punctuation">)</span></span>
...
<tr class="api-table-row">
<td><span id="external parameter-elevationtreshold"></span><span class="ctoken-line"><span class="ctoken class-name">elevationTreshold</span></span></td>
