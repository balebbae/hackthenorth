---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.SceneSegmentation.ARSceneSegmentationManager.TrySetChannelConfidenceThresholds/
...
A dictionary consisting of keys specifying the scene segmentation channel that is needed and values<br />
between 0 and 1, inclusive, that set the threshold above which the platform will include the specified<br />
channel in the packed scene segmentation buffer. The key must be a semantic channel present in the list<br />
