---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.XRSubsystems.XRVps2Subsystem.GetSessionId/
title: GetSessionId
---
...
True if a session id is present, false otherwise
...
<td><span id="external parameter-sessionid"></span><span class="ctoken-line"><span class="ctoken class-name">sessionId</span></span></td>
<td><span class="ctoken-line"><span class="ctoken class-name keyword">string</span></span></td>
<td><div class="ctoken comment">
The session id as 32 character hexidecimal upper-case string.
</div></td>
</tr>
</tbody>
</table>
