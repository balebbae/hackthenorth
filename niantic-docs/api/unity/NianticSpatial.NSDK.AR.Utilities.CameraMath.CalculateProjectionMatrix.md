---
source: https://www.nianticspatial.com/docs/api/unity/NianticSpatial.NSDK.AR.Utilities.CameraMath.CalculateProjectionMatrix/
title: CalculateProjectionMatrix
---
...
The intrinsics of the physical camera.
</div></td>
</tr>
<tr class="api-table-row">
...
<td><span class="ctoken-line"><span class="ctoken class-name"><a href="https://docs.unity3d.com/Packages/com.unity.xr.arsubsystems@4.2/api/UnityEngine.XR.ARSubsystems.XRCameraParams.html" target="_blank" rel="noopener noreferrer" title="Opens an external reference">XRCameraParams</a></span></span></td>
<td><div class="ctoken comment">
Presentation params of the virtual camera.
</div></td>
</tr>
<tr class="api-table-row">
<td><span id="external parameter-useopenglconvention"></span><span class="ctoken-line"><span class="ctoken class-name">useOpenGLConvention</span></span></td>
<td><span class="ctoken-line"><span class="ctoken class-name keyword">bool</span></span></td>
<td><div class="ctoken comment">
Whether to construct an OpenGL-like projection matrix.
</div></td>
</tr>
</tbody>
</table>
