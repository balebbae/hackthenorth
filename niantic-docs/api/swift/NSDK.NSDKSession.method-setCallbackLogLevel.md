---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.NSDKSession.method-setCallbackLogLevel/
...
<td><span id="external parameter-loglevel"></span><span class="ctoken-line"><span class="ctoken class-name">logLevel</span></span></td>
...
The desired log level for callback logging
</div></td>
</tr>
</tbody>
</table>
