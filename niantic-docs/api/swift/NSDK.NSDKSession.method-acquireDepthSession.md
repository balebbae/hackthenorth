---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.NSDKSession.method-acquireDepthSession/
title: acquireDepthSession
---
...
<span class="ctoken-line"><span class="ctoken plain">@</span><span class="ctoken plain">MainActor</span><span class="ctoken plain"> </span><span class="ctoken keyword">func</span><span class="ctoken plain"> </span><span class="ctoken class-name">acquireDepthSession</span><span class="ctoken plain">() -\> </span><span class="ctoken class-name">[NSDKDepthSession](https://www.nianticspatial.com/docs/api/swift/NSDK.class-NSDKDepthSession/ "Depth feature session for NSDK with Combine publisher support....")</span></span>
