---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.NSDKSitesSession.method-requestAssetsForSite/
...
An `AssetResult` containing the assets.
...
The site ID to fetch assets for.
</div></td>
</tr>
<tr class="api-table-row">
