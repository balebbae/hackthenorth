---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.SceneSegmentationChannels.method-isSuperset/
title: isSuperset
---
...
`true` if the set is a superset of `other`; otherwise,\
`false`.
