---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.NSDKSitesSession.method-requestAssetInfo/
...
An `AssetResult` containing the asset info.
...
<td><span id="external parameter-assetid"></span><span class="ctoken-line"><span class="ctoken class-name">assetId</span></span></td>
