---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.SceneSegmentationChannels.method-isStrictSuperset/
title: isStrictSuperset
---
...
`true` if the set is a strict superset of `other`; otherwise,\
`false`.
