---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.ImageMath.method-affineScaling/
title: affineScaling
---
...
<td><span id="external parameter-sx"></span><span class="ctoken-line"><span class="ctoken class-name">sx</span></span></td>
...
<tr class="api-table-row">
<td><span id="external parameter-sy"></span><span class="ctoken-line"><span class="ctoken class-name">sy</span></span></td>
<td><span class="ctoken-line"><span class="ctoken class-name keyword"><a href="https://developer.apple.com/documentation//swift/float" target="_blank" rel="noopener noreferrer" title="Opens an external reference">Float</a></span></span></td>
<td><div class="ctoken comment deemphasize">
-
</div></td>
