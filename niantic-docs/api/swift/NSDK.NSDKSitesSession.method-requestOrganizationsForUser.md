---
source: https://www.nianticspatial.com/docs/api/swift/NSDK.NSDKSitesSession.method-requestOrganizationsForUser/
title: requestOrganizationsForUser
---
...
The user ID to fetch organizations for.
</div></td>
</tr>
<tr class="api-table-row">
